-- 1. Drop the existing function (required to change parameter names)
DROP FUNCTION IF EXISTS save_word_with_preferences(jsonb, uuid, uuid, jsonb);

-- 2. Re-create the function with prefixed parameter names to avoid ambiguity and collision
