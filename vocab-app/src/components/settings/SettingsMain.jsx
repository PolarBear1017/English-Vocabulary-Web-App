...
import { ArrowRight, User, Key, Brain, BookOpen, Volume2 } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="text-left">
            <div className="font-bold text-gray-800">發音設定</div>
            <div className="text-sm text-gray-500">調整發音來源優先順序</div>
          </div>
        </div>
        <ArrowRight className="w-5 h-5 text-gray-300" />
      </button>
