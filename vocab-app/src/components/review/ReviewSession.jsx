          ...
          {!isFlipped ? (
            <>
              ...
              {reviewMode === 'dictation' && (
                <div className="space-y-6 w-full flex flex-col items-center">
                  <button onClick={() => speak(currentReviewWord.word, preferredReviewAudio, { rate: audioSpeed || 1.0 })} className="w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 hover:bg-blue-200 transition animate-pulse"><Volume2 className="w-8 h-8" /></button>
                  <div className="relative w-full">
            ...
            <div className="space-y-4 animate-in fade-in duration-300 w-full">
              <div className="flex items-center justify-center gap-3">
                ...
                <button onClick={() => speak(currentReviewWord.word, preferredReviewAudio, { rate: audioSpeed || 1.0 })}><Volume2 className="w-6 h-6 text-blue-600" /></button>
